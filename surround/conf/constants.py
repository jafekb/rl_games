...
D3QN_LR = 3e-5  # fine-tuning: small steps to avoid overwriting round-1 policy
D3QN_N_STEP = 3
...
D3QN_FORCE_RESUME_FROM: Path | None = Path("runs/surround/autoresearch/best")  # round-1 seed
D3QN_CURRICULUM = False  # set True to enable curriculum phase training
D3QN_MULTIDIFF_DIFFICULTIES: list[int] | None = None  # set to [0,1,2,3] for multi-diff training
